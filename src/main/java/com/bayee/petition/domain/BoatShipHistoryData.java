 ...
 */
public class BoatShipHistoryData implements TutorialData {

    private static final Logger logger = LoggerFactory.getLogger(BoatShipHistoryData.class);
    ...
    public List<SimpleFeature> getTestData(List<String> jsons) {
        if (features == null) {
            ...
            for (String json : jsons) {
                ...
                SimpleFeature feature = builder.buildFeature((jsonObject.getString("mmsi")+"_"+jsonObject.getString("update_time")));
